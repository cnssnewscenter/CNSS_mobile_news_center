var app = angular.module('MobileNews', ['mm.foundation', 'ngResource', 'slick', 'ngRoute', 'angular-loading-bar', 'angular-spinkit', 'ngAnimate'])
...
app.controller('PassageCtrl', ['api', '$scope', '$routeParams', '$sce', function(api, $scope, $routeParams, $sce){
    api.passage.get({id: $routeParams.id}, function(result){
